  ...
  <b-col v-if="showForm" sm="6">
    <b-card>
      ...
      <b-form-group>
        ...
        <b-form-radio-group
          ...
          <div class="custom-control custom-radio custom-control-inline">
            <input v-model="registeredObject.data_type" type="radio" id="customRadioDataTypeReal" name="customRadioInline1"
                   class="custom-control-input" value="1">
            <label class="custom-control-label" for="customRadioDataTypeReal">REAL</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input v-model="registeredObject.data_type" type="radio" id="customRadioDataTypeBool" name="customRadioInline1"
        ...
        <b-col sm="4">
          <b-form-group>
            ...
            <b-form-radio-group
              ...
              name="customRadioInline1">
              <div class="custom-control custom-radio custom-control-inline">
                <input v-model="registeredObject.data_type" type="radio" id="customRadioSettableTrue" name="customRadioInline1"
                       class="custom-control-input" value="1">
                <label class="custom-control-label" for="customRadioSettableTrue">Ano</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input v-model="registeredObject.data_type" type="radio" id="customRadioSettableFalse" name="customRadioInline1"
                       class="custom-control-input" value="2" checked>
      ...
      <div slot="footer">
        ...
        <b-button v-on:click="clearFormAndHide()" type="reset" size="sm" variant="danger"><i class="fa fa-ban"></i> Smazat</b-button>
      </div>
    </b-card>
  </b-col>
</transition>
