      ...
      <b-card>
        <b-row>
          ...
          <b-col sm="6" class="d-none d-md-block">
            <b-button type="button" variant="secondary" class="float-right"><i class="cui-chevron-bottom"></i>
            </b-button>
          </b-col>
        </b-row>
        <br>
              ...
              <tr v-for="item in farmObjects">
                ...
                <td>
                  <b-button-toolbar class="float-right" aria-label="Možnosti synchronizace">
                    <b-button type="button" variant="primary" class="float-right"><i class="cui-list icons"></i></b-button>
                    <b-button type="button" variant="warning" class="float-right"><i class="cui-note icons"></i></b-button>
